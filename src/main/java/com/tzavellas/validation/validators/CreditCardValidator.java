 ...
 * 
 * <p>By default, all supported card types are allowed.  You can specify which 
 * cards should pass validation by configuring the validation options.  For 
 * example,<br>
 * <pre>CreditCardValidator ccv = new CreditCardValidator(CreditCardValidator.AMEX + CreditCardValidator.VISA);</pre>
 * <br>configures the validator to only pass American Express and Visa cards.
 ...
 * <code>addAllowedCardType</code> method.</p>
 * 
 * <p>For a similar implementation in Perl, reference Sean M. Burke's
 * <a href="http://www.speech.cs.cmu.edu/~sburke/pub/luhn_lib.html">script</a>.
 * More information is also available
 * <a href="http://www.merriampark.com/anatomycc.htm">here</a>.</p>
 *
...
public class CreditCardValidator implements Validator<String> {
     ...
     */
    private Collection<CreditCardType> cardTypes = new ArrayList<CreditCardType>();
    ...
    public boolean isValid(String card) {
        ...
        cardTypes.contains(null);
        
        for (CreditCardType type : cardTypes) {
